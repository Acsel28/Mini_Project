...
class ProfileScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return WellnessScaffold(
      title: 'Profile',
      subtitle: 'Personal wellness identity',
      actions: [
        IconButton(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          if (user.disease != null || user.fitnessGoal != null || user.dietPreference != null) ...[
            ...
            Wrap(
              ...
              children: [
                if (user.disease != null)
                  _buildProfileChip(Icons.healing, user.disease!),
                if (user.fitnessGoal != null)
                  _buildProfileChip(Icons.flag_outlined, user.fitnessGoal!),
                if (user.dietPreference != null)
                  _buildProfileChip(Icons.restaurant, user.dietPreference!),
              ],
            ),
          ],
        ],
          ...
          builder: (innerContext, setState) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                ListTile(
                  leading: const Text('हिन्दी (Hindi)'),
                  trailing: WellnessChoiceIndicator(
