                  ...
                  Row(
                    children: [
                      if (meal.cuisine.isNotEmpty) ...[
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              const Icon(Icons.apps_rounded, size: 10, color: AppColors.textSecondary),
                      ...
                      Container(
                        padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                        decoration: BoxDecoration(
                          color: _getDifficultyColor(meal.difficulty).withValues(alpha: 0.1),
                          borderRadius: BorderRadius.circular(12),
                        ),
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            Icon(Icons.flag_circle_rounded, size: 10, color: _getDifficultyColor(meal.difficulty)),
                            const SizedBox(width: 4),
                            Text(
                              meal.difficulty,
                              style: TextStyle(
